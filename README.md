...
- O projeto é estático e não possui backend próprio, banco de dados, login ou armazenamento de dados pessoais.
- As perguntas são carregadas no navegador pela API pública Tryvia; como fallback de conectividade, o código pode consultar proxies públicos de CORS.
- A biblioteca Chart.js é carregada por CDN em versão fixa, com verificação de integridade no HTML.
